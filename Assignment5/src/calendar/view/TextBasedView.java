...
public class TextBasedView implements ICalendarView {
  ...
  public void displayMessage(String message) {
    try {
      if (message.startsWith("create") || message.startsWith("edit") ||
              message.startsWith("print") || message.startsWith("show") ||
              message.equals("menu (Show this menu)") ||
              message.equals("q or quit (Exit the program)")) {
        this.out.append(" -> ").append(message).append("\n");
      } else {
