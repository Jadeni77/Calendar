...
/**
 * This JUnit test class tests common functionality between the existing ICalendarModel
 * implementations, CalendarModel and NewCalendarModel.
 */
public abstract class AbstractCalendarModelTest {
  private ICalendar calendarModel;
  private ICalendar cm2;
  ...
  public void testCreateRecurringEvent() {
    ICalendar model = createCalendarModel();
